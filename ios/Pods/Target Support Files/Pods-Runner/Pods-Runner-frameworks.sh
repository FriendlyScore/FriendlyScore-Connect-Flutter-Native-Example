...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/FriendlyScoreConnect/FriendlyScoreConnect.framework"
  install_framework "${PODS_ROOT}/FriendlyScoreCore/FriendlyScoreCore.framework"
